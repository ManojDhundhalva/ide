      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <h1 style={{ fontSize: "20px", fontWeight: "600", margin: 0, color: "#cccccc" }}>IDE</h1>
          </div>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "800px" }}>
              <thead style={{ backgroundColor: "#2d2d30", borderBottom: "1px solid #3e3e42" }}>
                <tr>
                  <th style={{ padding: "12px 24px", textAlign: "left", fontSize: "14px", fontWeight: "500", color: "#cccccc", whiteSpace: "nowrap", fontWeight: "bold" }}>
                    Project name
                  </th>
                  <th style={{ padding: "12px 24px", textAlign: "left", fontSize: "14px", fontWeight: "500", color: "#cccccc", whiteSpace: "nowrap", fontWeight: "bold" }}>
                    Created On
                  ...
                  <th style={{ padding: "12px 24px", textAlign: "left", fontSize: "14px", fontWeight: "500", color: "#cccccc", fontWeight: "bold" }}>
                    <button
                    ...
                    >
                      ...
                      <td style={{ padding: "16px 24px" }}>
                        <button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.backgroundColor = "#5a1d1d";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.backgroundColor = "transparent";
                          }}
